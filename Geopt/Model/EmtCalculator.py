...
# The authors state that: 'You may use the code for whatever you like. You may study and modify it'. This can be viewed here: https://wiki.fysik.dtu.dk/ase/development/licenseinfo.html
# The original source code can be found here: https://wiki.fysik.dtu.dk/ase/_modules/ase/calculators/emt.html#EMT
# This is the reference to the authors:
...
parameters = {
    ...
    #################################################################
    # This is my own code, added to allow this to work with my program.
    ...
    'Be': (-3.34, 112/53, 0.3, 1.652, 2.790, 1.892, 0.01),
    # Assume that the P-block is all similar.
    'B': (-5.81, 87/53, 0.2, 1.652, 2.790, 3.892, 0.01),
    'F': (-0.84, 42/53, 0.2, 1.652, 2.790, 1.892, 0.01),
    'Ne': (-0.020, 38/53, 0.1, 1.652, 2.790, 1.892, 0.01),
    'Na': (-1.113, 190/53, 1.6, 1.652, 2.790, 1.892, 0.01),
    'Mg': (-1.51, 145/53, 1.5, 1.652, 2.790, 1.892, 0.01),
    'Si': (-4.63, 111/53, 1.3, 1.652, 2.790, 1.892, 0.01),
    'P': (-3.43, 98/53, 1.2, 1.652, 2.790, 1.892, 0.01),
    'S': (-2.85, 88/53, 1.1, 1.652, 2.790, 1.892, 0.01),
    'Cl': (-1.40, 79/53, 1.0, 1.652, 2.790, 1.892, 0.01),
    'Ar': (-0.080, 71/53, 0.1, 1.652, 2.790, 1.892, 0.01),
    'K': (-0.934, 243/53, 2.6, 1.652, 2.790, 1.892, 0.01),
    'Ca': (-1.84, 194/53, 2.5, 1.652, 2.790, 1.892, 0.01),
    # Assume that the D-block is all similar.
    'Sc': (-3.90, 184/53, 4.3, 1.652, 2.790, 1.892, 0.01),
    'Ti': (-4.85, 176/53, 4.2, 1.652, 2.790, 1.892, 0.01),
    'V': (-5.31, 171/53, 4.1, 1.652, 2.790, 1.892, 0.01),
    'Cr': (-4.10, 166/53, 4.0, 1.652, 2.790, 1.892, 0.01),
    'Mn': (-2.92, 161/53, 3.9, 1.652, 2.790, 1.892, 0.01),
    'Fe': (-4.28, 156/53, 3.8, 1.652, 2.790, 1.892, 0.01),
    'Co': (-4.39, 152/53, 3.7, 1.652, 2.790, 1.892, 0.01),
    'Zn': (-1.35, 142/53, 2.3, 1.652, 2.790, 1.892, 0.01),
    # Assume that the P-block is all similar.
    'Ga': (-2.81, 136/53, 2.4, 1.652, 2.790, 1.892, 0.01),
    'Ge': (-3.85, 125/53, 2.3, 1.652, 2.790, 1.892, 0.01),
    'As': (-2.96, 114/53, 2.2, 1.652, 2.790, 1.892, 0.01),
    'Se': (-2.46, 103/53, 2.1, 1.652, 2.790, 1.892, 0.01),
    'Br': (-1.22, 94/53, 2.0, 1.652, 2.790, 1.892, 0.01),
    'Kr': (-0.116, 88/53, 0.1, 1.652, 2.790, 1.892, 0.01),
    'Rb': (-0.852, 265/53, 3.6, 1.652, 2.790, 1.892, 0.01),
    'Sr': (-1.72, 219/53, 3.5, 1.652, 2.790, 1.892, 0.01),
    # Assume that the D-block is all similar.
    'Y': (-4.37, 212/53, 3.4, 1.652, 2.790, 1.892, 0.01),
    'Zr': (-6.25, 206/53, 3.3, 1.652, 2.790, 1.892, 0.01),
    'Nb': (-7.57, 198/53, 3.2, 1.652, 2.790, 1.892, 0.01),
    'Mo': (-6.82, 190/53, 3.1, 1.652, 2.790, 1.892, 0.01),
    'Tc': (-6.85, 183/53, 3.0, 1.652, 2.790, 1.892, 0.01),
    'Ru': (-6.74, 178/53, 2.9, 1.652, 2.790, 1.892, 0.01),
    'Rh': (-5.75, 173/53, 2.8, 1.652, 2.790, 1.892, 0.01),
    'Cd': (-1.16, 161/53, 2.0, 1.652, 2.790, 1.892, 0.01),
    # Assume that the P-block is all similar.
    'In': (-2.52, 156/53, 3.4, 1.652, 2.790, 1.892, 0.01),
    'Sn': (-3.14, 145/53, 3.3, 1.652, 2.790, 1.892, 0.01),
    'Sb': (-2.75, 133/53, 3.2, 1.652, 2.790, 1.892, 0.01),
    'Te': (-2.19, 123/53, 3.1, 1.652, 2.790, 1.892, 0.01),
    'I': (-1.11, 115/53, 3.0, 1.652, 2.790, 1.892, 0.01),
    'Xe': (-0.16, 108/53, 0.1, 1.652, 2.790, 1.892, 0.01),
    'Cs': (-0.804, 298/53, 3.6, 1.652, 2.790, 1.892, 0.01),
    'Ba': (-1.90, 253/53, 3.5, 1.652, 2.790, 1.892, 0.01),
    'Pb': (-2.03, 154/53, 4.3, 1.652, 2.790, 1.892, 0.01),
    # Assume that the D-block is all similar.
    'Hf': (-4.37, 212 / 53, 3.4, 1.652, 2.790, 1.892, 0.01),
    'Ta': (-6.25, 206 / 53, 3.3, 1.652, 2.790, 1.892, 0.01),
    'W': (-7.57, 198 / 53, 3.2, 1.652, 2.790, 1.892, 0.01),
    'Re': (-6.82, 190 / 53, 3.1, 1.652, 2.790, 1.892, 0.01),
    'Os': (-6.85, 183 / 53, 3.0, 1.652, 2.790, 1.892, 0.01),
    'Ir': (-6.74, 178 / 53, 2.9, 1.652, 2.790, 1.892, 0.01),
    # Assume that the P-block is all similar.
    'Tl': (-2.52, 156 / 53, 3.4, 1.652, 2.790, 1.892, 0.01),
    'Bi': (-2.75, 133 / 53, 3.2, 1.652, 2.790, 1.892, 0.01),
    'Po': (-2.19, 123 / 53, 3.1, 1.652, 2.790, 1.892, 0.01),
    'At': (-1.11, 115 / 53, 3.0, 1.652, 2.790, 1.892, 0.01),
    'Rn': (-0.16, 108 / 53, 0.1, 1.652, 2.790, 1.892, 0.01)
    }
    # End of my own code
    ######################################################################
