...
# I have added my own code to this class, which is on lines 45 to 135.
...
parameters = {
    ...
    #################################################################
    # My own code added to allow it to work with my program
    ...
    'He': (-1.30, 31/53, 0.132, 2.652, 2.790, 1.892, 0.00547),
    'Li': (-1.82, 167/53, 0.132, 2.652, 2.790, 1.892, 0.00547),
    'Be': (-3.34, 112/53, 0.132, 2.652, 2.790, 1.892, 0.00547),
    'B': (-5.81, 87/53, 0.132, 2.652, 2.790, 1.892, 0.00547),
    'F': (-0.84, 42/53, 0.132, 2.652, 2.790, 1.892, 0.00547),
    'Ne': (-0.020, 38/53, 0.132, 2.652, 2.790, 1.892, 0.00547),
    'Na': (-1.113, 190/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Mg': (-1.51, 145/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Si': (-4.63, 111/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'P': (-3.43, 98/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'S': (-2.85, 88/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Cl': (-1.40, 79/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Ar': (-0.080, 71/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'K': (-0.934, 243/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Ca': (-1.84, 194/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Sc': (-3.90, 184/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Ti': (-4.85, 176/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'V': (-5.31, 171/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Cr': (-4.10, 166/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Mn': (-2.92, 161/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Fe': (-4.28, 156/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Co': (-4.39, 152/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Zn': (-1.35, 142/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Ga': (-2.81, 136/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Ge': (-3.85, 125/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'As': (-2.96, 114/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Se': (-2.46, 103/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Br': (-1.22, 94/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Kr': (-0.116, 88/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Rb': (-0.852, 265/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Sr': (-1.72, 219/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Y': (-4.37, 212/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Zr': (-6.25, 206/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Nb': (-7.57, 198/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Mo': (-6.82, 190/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Tc': (-6.85, 183/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Ru': (-6.74, 178/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Rh': (-5.75, 173/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Cd': (-1.16, 161/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'In': (-2.52, 156/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Sn': (-3.14, 145/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Sb': (-2.75, 133/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Te': (-2.19, 123/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'I': (-1.11, 115/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Xe': (-0.16, 108/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Cs': (-0.804, 298/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Ba': (-1.90, 253/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Hg': (-0.67, 171/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    'Pb': (-2.03, 154/53, 0.132, 2.652, 2.790, 3.892, 0.00547),
    }
    # End of my own code
    ######################################################################
